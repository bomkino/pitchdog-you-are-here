...
function notes(answers: Answers): string[] {
  ...
  if (answers.priority === "relationship") result.push("Prefer one clear, well-timed communication over volume, urgency theatre, or an unasked attachment.");
